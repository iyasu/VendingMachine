define(["require", "exports", "./productFactory", "./coin", "./product"], function (require, exports, productFactory_1, Coin, product_1) {
    "use strict";
    ...
    var VendingMachine = (function () {
        function VendingMachine() {
            ...
            this.acceptedCoins = [new Coin.Dime(), new Coin.Quarter(), new Coin.Dollar(), new Coin.Half()];
